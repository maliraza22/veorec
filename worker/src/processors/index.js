...
function createDefaultRegistry({ logger, maintenance = true, stt = true, media = true } = {}) {
...
module.exports = { createDefaultRegistry, registerMaintenanceProcessors, registerSttProcessors, registerMediaProcessors };
